...
Exemple de carduri pentru dashboard-ul Home Assistant, create special pentru integrarea **Vehicule**.
Designul folosește carduri custom populare, cu culori condiționate (verde / portocaliu / roșu) în funcție de starea fiecărui senzor.
...
## 2. Documente (RCA, ITP, Impozit, Leasing)

Header cu status RCA (cel mai important document) — afișează zilele rămase, compania și numărul poliței.
Grid cu 3 indicatori: ITP, Impozit, Leasing — fiecare cu culoare condiționată.
